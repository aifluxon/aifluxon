...
Python uses the same path through PyO3. There is no separate Python runtime, model loop, budget, or tool ledger.
...
- Product UI, credentials storage, and OAuth flows
